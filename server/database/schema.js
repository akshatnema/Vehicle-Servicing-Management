...
var job_card="CREATE TABLE IF NOT EXISTS job_card(card_id INT AUTO_INCREMENT PRIMARY KEY NOT NULL, customer_id INT NOT NULL,street VARCHAR(30) NOT NULL, city VARCHAR(30) NOT NULL, state VARCHAR(30) NOT NULL,job_id INT NOT NULL,chassis_no VARCHAR(15) NOT NULL, purchase_date DATE NOT NULL, stage1 BOOLEAN,stage2 BOOLEAN,stage3 BOOLEAN,license_no INT NOT NULL, FOREIGN KEY (customer_id) REFERENCES customer(id))"  
